  ...
  return (
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
      ...
      <div>
        ...
        <TextField
          fullWidth
          value={formData.phoneNumber} // Prefilled with token value
          onChange={handleChange('phoneNumber')} // Uses handleChange to update state
      ...
      <div>
        ...
        <TextField
          fullWidth
          value={formData.email} // Prefilled with token value
          onChange={handleChange('email')} // Uses handleChange to update state
